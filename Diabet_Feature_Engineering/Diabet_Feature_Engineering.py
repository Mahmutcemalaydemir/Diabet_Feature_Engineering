...
# accuracy = 0.77 "Doğru tahminlerin toplam veriye oranı"
# Recall = 0.706
# Precision = 0.59
# F1 = 0.64
# Auc = 0.75
...
df["NEW_GLUCOSE"] = pd.cut(x=df["Glucose"], bins=[0, 140, 200, 300], labels=["Normal", "Pediabetes", "Diabetes"])
...
# insulin değeri ile kategorik değişken türetmek
